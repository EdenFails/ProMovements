    ...
    public class ReCategoryPage : UiElement
    {
        ...
        private static GameObject MenuPrefab
        {
            get
            {
                if (_menuPrefab == null)
                {
                    _menuPrefab = QuickMenuEx.Instance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_Dashboard").gameObject;
                }
                return _menuPrefab;
            }
        }
        ...
        {
            var dashboard = QuickMenuEx.Instance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_Dashboard").GetComponent<UIPage>();

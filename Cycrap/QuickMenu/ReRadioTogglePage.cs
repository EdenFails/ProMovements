    ...
    public class ReRadioTogglePage : UiElement
    {
        ...
        private static GameObject MenuPrefab
        {
            get
            {
                if (_menuPrefab == null)
                {
                    _menuPrefab = QuickMenuEx.Instance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_ChangeAudioInputDevice").gameObject;
                }
                return _menuPrefab;
            }
        }
